...
const FellowShip = () => {
  return (
    <div className="relative mx-auto px-6 grid mb-24  space-y-8  grid-cols-12 h-full   lg:px-28 ">
        ...
        <div className=" relative h-64 col-span-8 ">
            <Image 
                alt="blh"
        ...
        <div className=" relative h-32 col-span-4">
            <Image 
                        alt="blh"
                        src='https://media.graphassets.com/wo4PJgwtQFiu1xWmuE2D'
                        fill
