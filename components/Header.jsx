...
const Header = (props) => {
  ...
  return (
    ...
    <nav className='container border-b border-color-border mx-auto px-7   w-full flex  py-6 justify-between items-center navbar'>
        <Link href='/' >
            <>
                <Image  
                    src={logo}
        ...
        <ul className='list-none text-base sm:flex hidden justify-end items-center  flex-1'>
            ...
            <Link  href="/blog">
                <li className='font-poppins font-normal cursor-pointer  mr-10 text-white ' >教会活动</li>
            </Link>
            <Link  href="/offerings">
