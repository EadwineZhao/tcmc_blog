  ...
  return (
    ...
    <div className="my-16  mx-auto px-[1rem] lg:max-w-[1200px]">
      <div className="flex flex-col mt-[6rem] items-center justify-around px-[1rem] pb-[5rem]">
        ...
        <section className=" mx-auto  w-full py-10 text-left">
          <div className=" mx-auto max-w-[500px] px-2 lg:px-8  lg:max-w-[1200px]">
            <form className=" min-w-full flex flex-col gap-4 lg:flex-row justify-between items-start lg:items-center">

              {/* label wrapper*/}
              <div className="flex  max-w-full w-full flex-col gap-4 lg:flex-row">
                <label className=" w-full bg-white rounded-[10px]  flex  gap-4 h-12 py-[14px]  items-center pr-[14px] pl-[26px] lg:w-1/2">
                ...
                <label className="max-w-full bg-white rounded-[10px] flex gap-4 h-12 py-[14px] items-center pr-[14px] pl-[26px] lg:w-1/2">
                  <div className="w-[18px] h-[18px]">
      ...
      <div className="article bg-white rounded-lg shadow-lg overflow-hidden mb-10 ">
        <Link href='#' className=" flex flex-col lg:flex-row ">
          ...
          <div className="flex-1 flex flex-col gap-2 justify-center p-6">
            <h2 className="font-bold text-color-text-blog-title text-[28px] mb-2">
              小组重中之重重中之重
            </h2>
            ...
            <div key={group.id} className=" mb-6 bg-white overflow-hidden rounded-lg shadow-lg items-stretch max-w-sm  lg:flex-[1_1_30%]">
                <Link href="/groups" className="inline-flex   flex-col h-full ">
                  ...
                  <div className=" flex-grow flex  flex-col gap-2 justify-between p-6">
                    <h3 className="font-bold text-color-text-blog-title text-xl mb-2">
                      小组名称：{group.name}
                    </h3>
                    ...
                    <div className="flex mt-[2rem] ">
                        <span 
                          className=" bg-color-text-blog-tag py-1 px-2 text-sm text-color-text-btn rounded "
                        >
                          团契，聚餐
                        </span>
                    </div>
